...
test("repro24: C70593 schematic rectangle is missing from KiCad", async () => {
  ...
  circuit.add(
    ...
    >
      ...
      <trace from=".U3 > .MDI0P" to=".J_ETH > .MDI0P" pcbStraightLine />
      <trace from=".U3 > .MDI0N" to=".J_ETH > .MDI0N" pcbStraightLine />
      <trace from=".U3 > .MDI1P" to=".J_ETH > .MDI1P" pcbStraightLine />
      <trace from=".U3 > .MDI1N" to=".J_ETH > .MDI1N" pcbStraightLine />
      <trace from=".U3 > .MDI2P" to=".J_ETH > .MDI2P" pcbStraightLine />
