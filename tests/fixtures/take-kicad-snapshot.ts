  ...
  try {
    ...
    const exportCmd =
      kicadFileType === "sch"
        ...
        : $`kicad-cli pcb export svg ${inputFilePath} -o ${join(outputDir, "temp_file.svg")} --layers F.Cu,B.Cu,F.SilkS,B.SilkS --mode-single --page-size-mode 2 --exclude-drawing-sheet`
