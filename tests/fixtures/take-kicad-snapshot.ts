  ...
  try {
    ...
    const exportCmd =
      kicadFileType === "sch"
        ...
        : $`kicad-cli pcb export svg ${inputFilePath} -o ${join(outputDir, "temp_file.svg")} --layers B.Cu,F.Cu,F.SilkS,B.SilkS,F.Fab,B.Fab,Edge.Cuts --mode-single --page-size-mode 2 --exclude-drawing-sheet`
